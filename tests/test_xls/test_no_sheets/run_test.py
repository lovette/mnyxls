...
from tests.testutils import caplog_warning_messages, create_and_compare_workbook
...
def test_no_sheets(  # noqa: D103
    ...
    assert "No worksheets were generated." in caplog_warning_messages(caplog)
